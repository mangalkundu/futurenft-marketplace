...
@endif
        ...
        <div class="verification-container">
            ...
            <form class="verification-form" action="{{ route('user.verify.email') }}" method="POST">
                @csrf
            
                <p class="verification-text">Sent to: <strong>{{ showEmailAddress(auth()->user()->email) }}</strong></p>
                ...
                <div class="form-group text-center">
                    <p>
                        <center><span class="countdown-wrapper">Try again in <span id="countdown" class="fw-bold">03:00</span></span>
                        <a href="{{ route('user.send.verify.code', 'email') }}" class="try-again-link d-none">Try again</a></center>
                    </p>
...
// Countdown timer
    var distance = Number("{{ @$user->ver_code_send_at->addMinutes(3)->timestamp - time() }}");
